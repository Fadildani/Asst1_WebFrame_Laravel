...
<div id="visionCarousel" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ asset('images/1.jpg') }}" class="d-block w-100 carousel-img" alt="Cinta Yasmin">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('images/abetaekwondo.png') }}" class="d-block w-100 carousel-img" alt="Drama Lain">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('images/kiri.png') }}" class="d-block w-100 carousel-img" alt="Sports">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('images/purbaya.png') }}" class="d-block w-100 carousel-img" alt="Drama Lain">
        </div>
    </div>
...
<div class="content-wrapper">
    ...
    <div class="content-grid">
        ...
        <div class="main-content">
            ...
            <div class="news-card news-card-medium">
                <img src="{{ asset('images/cipung.png') }}" class="card-image" alt="Featured News">
            ...
            <!-- Medium Cards -->
            <div class="news-card news-card-medium">
                <img src="{{ asset('images/sty.png') }}" class="card-image" alt="Sports News">
                <div class="card-content">
                    <div>
            ...
            <div class="news-card news-card-medium">
                <img src="{{ asset('images/bahlil.png') }}" class="card-image" alt="Government News">
                <div class="card-content">
                    <div>
    ...
    <div class="bottom-grid">
        <div class="news-card news-card-small">
            <img src="{{ asset('images/ayu.png') }}" class="card-image" alt="News">
            <div class="card-content">
                <div>
                    <span class="card-badge konyol">Berita Konyol</span>
        ...
        <div class="news-card news-card-small">
            <img src="{{ asset('images/list.jpg') }}" class="card-image" alt="Weather">
            <div class="card-content">
                <div>
        ...
        <div class="news-card news-card-small">
            <img src="{{ asset('images/timnas.png') }}" class="card-image" alt="News">
            <div class="card-content">
                <div>
                    <span class="card-badge sport">Berita Sport</span>
